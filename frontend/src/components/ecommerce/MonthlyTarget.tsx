...
export default function MonthlyTarget() {
  ...
  useEffect(() => {
    fetch("https://backend-of-railnova.vercel.app/api/wagon-totals", { credentials: "include" })
      .then(res => {
  ...
  // Fetch IC stats
  useEffect(() => {
    fetch("https://backend-of-railnova.vercel.app/api/ic-stats", { credentials: "include" })
      .then(res => {
        if (!res.ok) throw new Error(`HTTP error! Status: ${res.status}`);
        return res.json();
      })
